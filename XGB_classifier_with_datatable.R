...
train <- fread('~/R/My Projects/crime classification/input/train.csv')

test <- fread('~/R/My Projects/crime classification/input/test.csv')
...
#names(prediction)
write.csv(prediction, 'submission2.csv', row.names=FALSE, quote=FALSE)
